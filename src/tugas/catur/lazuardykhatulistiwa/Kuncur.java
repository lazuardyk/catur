...
public class Kuncur extends BidakCatur {

	public Kuncur(String warna, String lokasi, PapanCatur papan) {
	...
	public boolean gerakin(String tujuan) {
		...
		if ( (baristujuan > 8) || (baristujuan < 1) || (kolomtujuan > 8) || (kolomtujuan < 1) ) {
			...
			if (tabrakan == 0) {
				...
				System.out.println("Kuncur berhasil pindah!");
				return true;
			} else {
				System.out.println("Kuncur nabrak bidak!");
				return false;
			}
		} else {
